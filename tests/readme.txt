...
I have also completed the unit testing for the quad solver function, but I am stuck on the user input and input validation unit tests, as I am pretty lost on how to get through that. You can use the quad solver unit test file for reference on how I did that. Or, if you want, you can change it completely if it makes it easier.
